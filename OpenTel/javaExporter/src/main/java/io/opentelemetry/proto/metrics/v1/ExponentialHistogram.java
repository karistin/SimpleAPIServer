...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              dataPoints_ = new java.util.ArrayList<ExponentialHistogramDataPoint>();
              mutable_bitField0_ |= 0x00000001;
            }
            dataPoints_.add(
                input.readMessage(ExponentialHistogramDataPoint.parser(), extensionRegistry));
            break;
          }
          case 16: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return MetricsProto.internal_static_opentelemetry_proto_metrics_v1_ExponentialHistogram_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return MetricsProto.internal_static_opentelemetry_proto_metrics_v1_ExponentialHistogram_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ExponentialHistogram.class, Builder.class);
  }

  public static final int DATA_POINTS_FIELD_NUMBER = 1;
  private java.util.List<ExponentialHistogramDataPoint> dataPoints_;
  /**
   ...
   */
  @Override
  public java.util.List<? extends ExponentialHistogramDataPointOrBuilder>
   ...
   */
  @Override
  public ExponentialHistogramDataPointOrBuilder getDataPointsOrBuilder(
      int index) {
    return dataPoints_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    ExponentialHistogram other = (ExponentialHistogram) obj;
  ...
  public static ExponentialHistogram parseFrom(
  ...
  public static ExponentialHistogram parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ExponentialHistogram parseFrom(
  ...
  public static ExponentialHistogram parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ExponentialHistogram parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ExponentialHistogram parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ExponentialHistogram prototype) {
  ...
  public static final class Builder extends
    ...
    public ExponentialHistogram build() {
      ExponentialHistogram result = buildPartial();
    ...
    public ExponentialHistogram buildPartial() {
      ExponentialHistogram result = new ExponentialHistogram(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ExponentialHistogram) {
        return mergeFrom((ExponentialHistogram)other);
      } else {
    ...
    public Builder mergeFrom(ExponentialHistogram other) {
      if (other == ExponentialHistogram.getDefaultInstance()) return this;
      if (dataPointsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ExponentialHistogram parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ExponentialHistogram) e.getUnfinishedMessage();
    ...
    private void ensureDataPointsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        dataPoints_ = new java.util.ArrayList<ExponentialHistogramDataPoint>(dataPoints_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        ExponentialHistogramDataPoint, ExponentialHistogramDataPoint.Builder, ExponentialHistogramDataPointOrBuilder> dataPointsBuilder_;
    ...
    public Builder setDataPoints(
        int index, ExponentialHistogramDataPoint value) {
      if (dataPointsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setDataPoints(
        int index, ExponentialHistogramDataPoint.Builder builderForValue) {
      if (dataPointsBuilder_ == null) {
        ensureDataPointsIsMutable();
     ...
     * <code>repeated .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint data_points = 1;</code>
     */
    public Builder addDataPoints(ExponentialHistogramDataPoint value) {
      if (dataPointsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addDataPoints(
        ExponentialHistogramDataPoint.Builder builderForValue) {
      if (dataPointsBuilder_ == null) {
        ensureDataPointsIsMutable();
    ...
    public Builder addAllDataPoints(
        Iterable<? extends ExponentialHistogramDataPoint> values) {
      if (dataPointsBuilder_ == null) {
        ensureDataPointsIsMutable();
     ...
     * <code>repeated .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint data_points = 1;</code>
     */
    public ExponentialHistogramDataPoint.Builder getDataPointsBuilder(
        int index) {
    ...
    public ExponentialHistogramDataPoint.Builder addDataPointsBuilder(
        int index) {
      return getDataPointsFieldBuilder().addBuilder(
          index, ExponentialHistogramDataPoint.getDefaultInstance());
    }
    /**
     * <code>repeated .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint data_points = 1;</code>
     */
    public java.util.List<ExponentialHistogramDataPoint.Builder>
         getDataPointsBuilderList() {
      return getDataPointsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ExponentialHistogramDataPoint, ExponentialHistogramDataPoint.Builder, ExponentialHistogramDataPointOrBuilder>
        getDataPointsFieldBuilder() {
      if (dataPointsBuilder_ == null) {
  ...
  private static final ExponentialHistogram DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ExponentialHistogram();
  }

  public static ExponentialHistogram getDefaultInstance() {
